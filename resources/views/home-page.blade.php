        ...
        <form class="w-full" action="{{ route('report.generate') }}">
            <div class="flex flex-col md:flex-row md:items-center gap-4">
                <div class="flex-1">
                    ...
                    <input class="w-full border border-gray-300 p-2 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="date" name="start" id="start">
                </div>
                <div class="flex-1">
                    <label for="end" class="block text-sm font-medium text-gray-700 mb-1">End Date</label>
                    <input class="w-full border border-gray-300 p-2 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" type="date" name="end" id="end">
                </div>
                <div class="flex-none self-end">
                    <button class="py-2 px-6 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition duration-200 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                        Generate Report
                    </button>
                </div>
            </div>
