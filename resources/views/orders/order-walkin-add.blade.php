    ...
    <form class="flex" action="{{ route('order_store') }}" method="post" autocomplete="off">
        ...
        <div class="flex flex-col min-w-96 max-w-96">
            ...
            <div class="border border-gray-300 rounded p-4 bg-white shadow-sm mb-4">
                <div class="mb-4">
                    <p class="text-lg font-semibold text-gray-900">Customer Information</p>
                    <p class="text-sm text-gray-600 mt-1">Select an existing customer or add a new one for this walk-in order.</p>
                </div>
            ...
            <div class="border border-gray-300 rounded p-4 bg-gray-50 shadow-sm">
                ...
                <div class="overflow-x-auto mb-4 border border-gray-200 rounded max-h-96 overflow-y-auto">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-3 py-2 text-center text-sm text-gray-700">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        <div class="flex">
                                            <button type="submit" title="Add one" formaction="{{ route('order_stage_add', ['product' => $product->id]) }}"
                                                class="px-2 py-1 bg-blue-500 text-white rounded-l hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300 transition-colors text-xs">+</button>
                                            <button type="submit" title="Subtract one" formaction="{{ route('order_stage_sub', ['product' => $product->id]) }}"
